...
# characters etc.)
datastory_name_de <- "forschung-entwicklung-schweiz"
datastory_name_en <- "research-development-switzerland"
datastory_name_fr <- "recherche-et-developpement-suisse"

# English title and lead of the story (Mandatory, even if no EN version)
title_en <- "How much money does Switzerland invest in research and development?" 
lead_en <- "Every year, the SNSF receives around one billion francs from the federal government. In 2019, a total of 22.9 billion Swiss francs was available for research and development (R&D) in Switzerland. Our country ranks seventh in terms GDP share spent on R&D." 
# German title and lead of the story (Mandatory, even if no DE version)
title_de <- "Wie viel Geld steckt die Schweiz in die Forschung und Entwicklung?" 
lead_de <- "Der SNF erhält pro Jahr rund eine Milliarde Franken vom Bund. Für die gesamte Forschung und Entwicklung (F&E) standen 2019 in der Schweiz 22,9 Milliarden Franken zur Verfügung. Gemessen am BIP liegt unser Land an siebter Stelle." 
# French title and lead of the story (Mandatory, even if no FR version)
title_fr <- "Combien d’argent la Suisse consacre-t-elle à la recherche et développement ?"
lead_fr <- "Le FNS reçoit environ un milliard de francs par an de la part de la Confédération. À titre de comparaison, un total de 22,9 milliards de francs a été investi dans la recherche et développement (R&D) en Suisse pour l’année 2019. Ainsi, la part de PIB consacré à la R&D hisse notre pays au septième rang des nations affichant les pourcentages les plus élevés." 
...
publication_date <- "2021-09-23 01:00:00"
...
doi <- "https://doi.org/10.46446/datastory.rd-financing" 
# URL to Github page (optional)
github_url <- "https://github.com/snsf-data/datastory_rd_financing" 
